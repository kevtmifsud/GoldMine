...
interface EarningsTranscriptsGridProps {
  symbol: string;
}
...
export function EarningsTranscriptsGrid({
  symbol,
}: EarningsTranscriptsGridProps) {
  ...
  const fetchTranscripts = useCallback(async () => {
    ...
    try {
      ...
      setError("Failed to load earnings transcripts");
    } finally {
      setLoading(false);
    }
  }, [symbol]);
